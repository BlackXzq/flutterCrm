...
import 'package:my_flutter/base/crm/customview/CustomPageView.dart';
...
class CarouselSlider extends StatefulWidget {
  CarouselSlider(
      ...
      : this.autoPlayInterval = autoPlayInterval ?? const Duration(seconds: 4),
        ...
        this.pageController = CustomPageController(
...
class _CarouselSliderState extends State<CarouselSlider>
  ...
  Widget build(BuildContext context) {
    print('AABBCC widget.items.length ${widget.items.length}');
    return getWrapper(CustomPageView.builder(
      scrollDirection: widget.scrollDirection,
      controller: widget.pageController,
      reverse: widget.reverse,
      pageWidth: widget.pageWidth,
      pageMargin: widget.pageMargin,
      extraWidth: widget.extraWidth,
      scale: widget.scale,
